...
/* ── AD_SLIDES — 15 flag placeholder slots across 3 groups of 5 ──
   ...
   Each slot has a unique flag and colour theme.
   Replace flag/placeholder content with live advertiser branding when sold.
── */
const AD_SLIDES = [
  /* ── GROUP 1 ── */
  {
    id:0, group:1, slot:1, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#1a0a2e 0%,#2d1b4e 50%,#4c1d95 100%)",
    flag:"🇯🇪", flagLabel:"Slot 1 of 15",
    eyebrow:{ text:"🇯🇪  SLOT 1 — GROUP 1", color:"#c4b5fd" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#c4b5fd", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Taxis & Cab Companies — Platinum exclusivity available", color:"#ddd6fe" },
    cta:{ label:"Claim this slot", labelColor:"#c4b5fd", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#7c3aed", arrowColor:"white", boxBg:"rgba(124,58,237,0.15)", boxBorder:"rgba(196,181,253,0.4)" },
    stats:[{ val:"1/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#c4b5fd",
    accent:"linear-gradient(90deg,transparent,#7c3aed55,transparent)",
  },
  {
    id:1, group:1, slot:2, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#052e16 0%,#14532d 50%,#166534 100%)",
    flag:"🇬🇧", flagLabel:"Slot 2 of 15",
    eyebrow:{ text:"🇬🇧  SLOT 2 — GROUP 1", color:"#86efac" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#86efac", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Builders Merchants — Platinum exclusivity available", color:"#bbf7d0" },
    cta:{ label:"Claim this slot", labelColor:"#86efac", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#16a34a", arrowColor:"white", boxBg:"rgba(22,163,74,0.15)", boxBorder:"rgba(134,239,172,0.4)" },
    stats:[{ val:"2/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#86efac",
    accent:"linear-gradient(90deg,transparent,#16a34a55,transparent)",
  },
  {
    id:2, group:1, slot:3, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#0c1445 0%,#1e3a8a 50%,#1d4ed8 100%)",
    flag:"🇫🇷", flagLabel:"Slot 3 of 15",
    eyebrow:{ text:"🇫🇷  SLOT 3 — GROUP 1", color:"#93c5fd" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#93c5fd", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Estate Agents — Platinum exclusivity available", color:"#bfdbfe" },
    cta:{ label:"Claim this slot", labelColor:"#93c5fd", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#2563eb", arrowColor:"white", boxBg:"rgba(37,99,235,0.15)", boxBorder:"rgba(147,197,253,0.4)" },
    stats:[{ val:"3/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#93c5fd",
    accent:"linear-gradient(90deg,transparent,#2563eb55,transparent)",
  },
  {
    id:3, group:1, slot:4, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#7f1d1d 0%,#991b1b 50%,#b91c1c 100%)",
    flag:"🇩🇪", flagLabel:"Slot 4 of 15",
    eyebrow:{ text:"🇩🇪  SLOT 4 — GROUP 1", color:"#fca5a5" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#fca5a5", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Car Dealerships — Platinum exclusivity available", color:"#fecaca" },
    cta:{ label:"Claim this slot", labelColor:"#fca5a5", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#dc2626", arrowColor:"white", boxBg:"rgba(220,38,38,0.15)", boxBorder:"rgba(252,165,165,0.4)" },
    stats:[{ val:"4/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#fca5a5",
    accent:"linear-gradient(90deg,transparent,#dc262655,transparent)",
  },
  {
    id:4, group:1, slot:5, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#1c1917 0%,#292524 50%,#44403c 100%)",
    flag:"🇮🇪", flagLabel:"Slot 5 of 15",
    eyebrow:{ text:"🇮🇪  SLOT 5 — GROUP 1", color:"#d6d3d1" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#d6d3d1", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Insurance Brokers — Platinum exclusivity available", color:"#e7e5e4" },
    cta:{ label:"Claim this slot", labelColor:"#d6d3d1", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#78716c", arrowColor:"white", boxBg:"rgba(120,113,108,0.15)", boxBorder:"rgba(214,211,209,0.4)" },
    stats:[{ val:"5/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#d6d3d1",
    accent:"linear-gradient(90deg,transparent,#78716c55,transparent)",
  },
  /* ── GROUP 2 ── */
  {
    id:5, group:2, slot:6, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#083344 0%,#0e7490 50%,#0891b2 100%)",
    flag:"🇪🇸", flagLabel:"Slot 6 of 15",
    eyebrow:{ text:"🇪🇸  SLOT 6 — GROUP 2", color:"#67e8f9" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#67e8f9", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Mortgage Brokers — Platinum exclusivity available", color:"#a5f3fc" },
    cta:{ label:"Claim this slot", labelColor:"#67e8f9", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#0891b2", arrowColor:"white", boxBg:"rgba(8,145,178,0.15)", boxBorder:"rgba(103,232,249,0.4)" },
    stats:[{ val:"6/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#67e8f9",
    accent:"linear-gradient(90deg,transparent,#0891b255,transparent)",
  },
  {
    id:6, group:2, slot:7, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#1e1b4b 0%,#312e81 50%,#4338ca 100%)",
    flag:"🇮🇹", flagLabel:"Slot 7 of 15",
    eyebrow:{ text:"🇮🇹  SLOT 7 — GROUP 2", color:"#a5b4fc" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#a5b4fc", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Removal Companies — Platinum exclusivity available", color:"#c7d2fe" },
    cta:{ label:"Claim this slot", labelColor:"#a5b4fc", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#4338ca", arrowColor:"white", boxBg:"rgba(67,56,202,0.15)", boxBorder:"rgba(165,180,252,0.4)" },
    stats:[{ val:"7/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#a5b4fc",
    accent:"linear-gradient(90deg,transparent,#4338ca55,transparent)",
  },
  {
    id:7, group:2, slot:8, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#064e3b 0%,#065f46 50%,#047857 100%)",
    flag:"🇵🇹", flagLabel:"Slot 8 of 15",
    eyebrow:{ text:"🇵🇹  SLOT 8 — GROUP 2", color:"#6ee7b7" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#6ee7b7", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Gyms & Fitness Centres — Platinum exclusivity available", color:"#a7f3d0" },
    cta:{ label:"Claim this slot", labelColor:"#6ee7b7", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#059669", arrowColor:"white", boxBg:"rgba(5,150,105,0.15)", boxBorder:"rgba(110,231,183,0.4)" },
    stats:[{ val:"8/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#6ee7b7",
    accent:"linear-gradient(90deg,transparent,#05966955,transparent)",
  },
  {
    id:8, group:2, slot:9, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#431407 0%,#7c2d12 50%,#c2410c 100%)",
    flag:"🇳🇱", flagLabel:"Slot 9 of 15",
    eyebrow:{ text:"🇳🇱  SLOT 9 — GROUP 2", color:"#fdba74" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#fdba74", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Garden Centres — Platinum exclusivity available", color:"#fed7aa" },
    cta:{ label:"Claim this slot", labelColor:"#fdba74", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#ea580c", arrowColor:"white", boxBg:"rgba(234,88,12,0.15)", boxBorder:"rgba(253,186,116,0.4)" },
    stats:[{ val:"9/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#fdba74",
    accent:"linear-gradient(90deg,transparent,#ea580c55,transparent)",
  },
  {
    id:9, group:2, slot:10, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#0f172a 0%,#1e293b 50%,#334155 100%)",
    flag:"🇦🇺", flagLabel:"Slot 10 of 15",
    eyebrow:{ text:"🇦🇺  SLOT 10 — GROUP 2", color:"#94a3b8" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#94a3b8", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Pharmacies — Platinum exclusivity available", color:"#cbd5e1" },
    cta:{ label:"Claim this slot", labelColor:"#94a3b8", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#475569", arrowColor:"white", boxBg:"rgba(71,85,105,0.15)", boxBorder:"rgba(148,163,184,0.4)" },
    stats:[{ val:"10/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#94a3b8",
    accent:"linear-gradient(90deg,transparent,#47556955,transparent)",
  },
  /* ── GROUP 3 ── */
  {
    id:10, group:3, slot:11, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#450a0a 0%,#7f1d1d 50%,#991b1b 100%)",
    flag:"🇨🇦", flagLabel:"Slot 11 of 15",
    eyebrow:{ text:"🇨🇦  SLOT 11 — GROUP 3", color:"#fda4af" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#fda4af", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Restaurants & Takeaways — Platinum exclusivity available", color:"#fecdd3" },
    cta:{ label:"Claim this slot", labelColor:"#fda4af", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#be123c", arrowColor:"white", boxBg:"rgba(190,18,60,0.15)", boxBorder:"rgba(253,164,175,0.4)" },
    stats:[{ val:"11/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#fda4af",
    accent:"linear-gradient(90deg,transparent,#be123c55,transparent)",
  },
  {
    id:11, group:3, slot:12, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#2e1065 0%,#4c1d95 50%,#6d28d9 100%)",
    flag:"🇯🇵", flagLabel:"Slot 12 of 15",
    eyebrow:{ text:"🇯🇵  SLOT 12 — GROUP 3", color:"#d8b4fe" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#d8b4fe", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Florists — Platinum exclusivity available", color:"#ede9fe" },
    cta:{ label:"Claim this slot", labelColor:"#d8b4fe", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#7c3aed", arrowColor:"white", boxBg:"rgba(124,58,237,0.15)", boxBorder:"rgba(216,180,254,0.4)" },
    stats:[{ val:"12/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#d8b4fe",
    accent:"linear-gradient(90deg,transparent,#7c3aed55,transparent)",
  },
  {
    id:12, group:3, slot:13, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#042f2e 0%,#134e4a 50%,#0f766e 100%)",
    flag:"🇧🇷", flagLabel:"Slot 13 of 15",
    eyebrow:{ text:"🇧🇷  SLOT 13 — GROUP 3", color:"#5eead4" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#5eead4", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Pet Food & Pet Shops — Platinum exclusivity available", color:"#99f6e4" },
    cta:{ label:"Claim this slot", labelColor:"#5eead4", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#0d9488", arrowColor:"white", boxBg:"rgba(13,148,136,0.15)", boxBorder:"rgba(94,234,212,0.4)" },
    stats:[{ val:"13/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#5eead4",
    accent:"linear-gradient(90deg,transparent,#0d948855,transparent)",
  },
  {
    id:13, group:3, slot:14, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#1a2e05 0%,#365314 50%,#4d7c0f 100%)",
    flag:"🇿🇦", flagLabel:"Slot 14 of 15",
    eyebrow:{ text:"🇿🇦  SLOT 14 — GROUP 3", color:"#bef264" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#bef264", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Electrical Retailers — Platinum exclusivity available", color:"#d9f99d" },
    cta:{ label:"Claim this slot", labelColor:"#bef264", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#65a30d", arrowColor:"white", boxBg:"rgba(101,163,13,0.15)", boxBorder:"rgba(190,242,100,0.4)" },
    stats:[{ val:"14/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#bef264",
    accent:"linear-gradient(90deg,transparent,#65a30d55,transparent)",
  },
  {
    id:14, group:3, slot:15, link:ENQUIRY_TRIGGER,
    bg:"linear-gradient(135deg,#1e1b4b 0%,#3730a3 50%,#4f46e5 100%)",
    flag:"🇺🇸", flagLabel:"Slot 15 of 15",
    eyebrow:{ text:"🇺🇸  SLOT 15 — GROUP 3", color:"#a5b4fc" },
    headline:{ before:"Your Business ", highlight:"Here", highlightColor:"#a5b4fc", after:" — Jersey's Shoppers", headlineColor:"#f0f4f8" },
    sub:{ text:"Hotels & Self-Catering — Platinum exclusivity available", color:"#c7d2fe" },
    cta:{ label:"Claim this slot", labelColor:"#a5b4fc", url:"jerseybasket.je", urlColor:"#f0f4f8", arrowBg:"#4f46e5", arrowColor:"white", boxBg:"rgba(79,70,229,0.15)", boxBorder:"rgba(165,180,252,0.4)" },
    stats:[{ val:"15/15", label:"slot" },{ val:"£999", label:"per month" }], statColor:"#a5b4fc",
    accent:"linear-gradient(90deg,transparent,#4f46e555,transparent)",
  },
];
