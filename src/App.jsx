...
const AD_SLIDES = [
  {
    ...
    stats:    [{ val:"1,200+", label:"weekly users" },{ val:`${BASE_PRODUCTS.length}`, label:"products" }],
    statColor:"#4ade80",
  ...
  },
  {
    ...
    sub:      { text:"Premium banner slot available — be seen by 1,200+ Jersey shoppers", color:"#a7f3d0" },
    ...
    stats:    [{ val:"1,200+", label:"active users" },{ val:"From £99", label:"per month" }],
    statColor:"#6ee7b7",
