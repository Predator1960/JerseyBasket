...
const BASE_PRODUCTS = [
  ...
  {id:537,name:"Gourmet Sausages (4pk)",       cat:"🥩 Meat & Fish",   icon:"🌭", prices:sp(4.60,[0,0,0,0,0])},
  ...
  {id:107,name:"Onions (3pk)",                 cat:"🥦 Fruit & Veg",  icon:"🧅", prices:sp(0.78,[0.27,0.47,0.67,0.73,0.47])},
  ...
  {id:530,name:"Golden Syrup (454g)",          cat:"🍝 Pantry",       icon:"🍯", prices:sp(1.56,[0,0,0,0,0])},
  {id:223,name:"Peanut Butter Smooth (340g)",  cat:"🍝 Pantry",       icon:"🥜", prices:sp(1.96,[0.03,0.44,0.44,0.86,1.54])},
  {id:531,name:"Chopped Garlic (90g)",         cat:"🍝 Pantry",       icon:"🧄", prices:sp(2.32,[0,0,0,0,0])},
  ...
  {id:532,name:"Malted Milk Biscuits",         cat:"🥨 Snacks & Treats",icon:"🍪",prices:sp(0.69,[0,0,0,0,0])},
  {id:533,name:"Milk Choc Digestives",         cat:"🥨 Snacks & Treats",icon:"🍪",prices:sp(1.38,[0,0,0,0,0])},
  ...
  {id:538,name:"Scotch Wholegrain Rice Cakes", cat:"🥨 Snacks & Treats",icon:"🍘",prices:sp(1.67,[0,0,0,0,0])},
  ...
  {id:527,name:"Lurpak Slightly Salted Butter (500g)",cat:"🥛 Dairy & Eggs", icon:"🧈",prices:sp(6.40,[0,0,0,0,0])},
  ...
  {id:529,name:"Arborio Risotto Rice (500g)",  cat:"🍝 Pantry",       icon:"🍚",prices:sp(3.08,[0,0,0,0,0])},
  {id:535,name:"Rigatoni Pasta (500g)",        cat:"🍝 Pantry",       icon:"🍝",prices:sp(1.00,[0,0,0,0,0])},
  {id:536,name:"Ambrosia Rice Pudding (400g)", cat:"🍝 Pantry",       icon:"🍮",prices:sp(1.25,[0,0,0,0,0])},
  ...
  {id:539,name:"Whipping Cream (300ml)",        cat:"🥛 Dairy & Eggs", icon:"🍦",prices:sp(2.09,[0,0,0,0,0])},
  ...
  {id:528,name:"Guinness Cans (4pk)",           cat:"🥤 Drinks",       icon:"🍺",prices:sp(13.86,[0,0,0,0,0])},
  ...
  {id:534,name:"Beef Meatballs 12pk",            cat:"🧊 Frozen",       icon:"🍝",prices:sp(5.22,[0,0,0,0,0])},
...
const AD_SLIDES = [
  {
    ...
    stats:    [{ val:"1,000+", label:"weekly users" },{ val:`${BASE_PRODUCTS.length}`, label:"products" }],
    statColor:"#4ade80",
  ...
  },
  {
    ...
    isAdvertiser: true,
    bg:       "#ffee00",
    logo:     "data:image/jpeg;base64,",
  ...
  const steps = [
    {
      ...
      subtitle: `Join 1,000+ Jersey shoppers saving money every week`,
