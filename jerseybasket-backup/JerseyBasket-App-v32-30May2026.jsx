...
const BASE_PRODUCTS = [
  ...
  {id:423,name:"Jersey Dairy Fresh Milk 1% (1L)",  cat:"🥔 Local Jersey", icon:"🥛",prices:sp(0.87,[0,0,0,0,0])},
  {id:424,name:"Jersey Dairy Fresh Milk 2.5% (500ml)",cat:"🥔 Local Jersey",icon:"🥛",prices:sp(0.87,[0,0,0,0,0])},
