 ...
 * Version:   v39
 * Updated:   1 June 2026
 * Changes:   Fix duplicate Add button in header, clean up second row layout
    ...
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#050d1a 0%,#0b1c35 55%,#061220 100%)", fontFamily:"'Georgia',serif", color:"#f0f4f8" }}>
      ...
      <header style={{ position:"sticky",top:0,zIndex:100, background:"rgba(5,13,26,.96)",backdropFilter:"blur(20px)", borderBottom:"1px solid rgba(255,255,255,.07)",padding:"0 16px" }}>
        <div style={{ maxWidth:1040,margin:"0 auto" }}>
          ...
          {/* ── SECOND ROW: nav tabs + add button ── */}
          <div style={{ display:"flex",gap:3,paddingBottom:9,alignItems:"center" }}>
            ...
            <button onClick={()=>setShowAddModal(true)} style={{ marginLeft:"auto",background:"rgba(34,197,94,.12)",border:"1px solid rgba(34,197,94,.3)",color:"#22c55e",borderRadius:7,padding:"4px 12px",cursor:"pointer",fontSize:11,fontWeight:700,whiteSpace:"nowrap",flexShrink:0 }}>+ Add</button>
          </div>
        </div>
      </header>
