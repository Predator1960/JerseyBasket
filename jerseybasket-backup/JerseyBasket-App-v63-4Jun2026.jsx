...
const AD_SLIDES = [
  ...
  },
  {
    ...
    sub:      { text:"Jersey's leading supplier of Tools, Agricultural & Automotive parts & accessories", color:"#14532d" },
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display:"flex", alignItems:"center", gap:"clamp(6px,1.5vw,14px)", minWidth:0, flex:1 }}>
                ...
                <div style={{ fontFamily:"'DM Sans',Arial,sans-serif", fontSize:"clamp(8px,1.1vh,11px)", color:s.sub.color, opacity:0.85, whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>
                  {s.sub.text}
                </div>
              </div>
