 ...
 * Version:   v38
 * Updated:   1 June 2026
 * Changes:   ESLint fixes for Vercel CI build (unused vars, hook deps, duplicate key)
    ...
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#050d1a 0%,#0b1c35 55%,#061220 100%)", fontFamily:"'Georgia',serif", color:"#f0f4f8" }}>
      ...
      <header style={{ position:"sticky",top:0,zIndex:100, background:"rgba(5,13,26,.96)",backdropFilter:"blur(20px)", borderBottom:"1px solid rgba(255,255,255,.07)",padding:"0 16px" }}>
        <div style={{ maxWidth:1040,margin:"0 auto" }}>
          <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:11,paddingBottom:8,gap:8 }}>
            <div style={{ minWidth:0,flexShrink:1 }}>
              <div style={{ display:"flex",alignItems:"center",gap:9 }}>
                ...
                <div>
                  <div style={{ fontSize:15,fontWeight:700,letterSpacing:"-0.5px",lineHeight:1.1,whiteSpace:"nowrap" }}>
          ...
          {/* ── SECOND ROW: nav tabs only ── */}
          <div style={{ display:"flex",gap:3,paddingBottom:9 }}><button onClick={()=>setShowAddModal(true)} style={{ marginLeft:"auto",background:"rgba(34,197,94,.12)",border:"1px solid rgba(34,197,94,.3)",color:"#22c55e",borderRadius:7,padding:"4px 12px",cursor:"pointer",fontSize:11,fontWeight:700,whiteSpace:"nowrap" }}>+ Add</button>
            ...
            <button onClick={()=>setShowAddModal(true)} style={{ marginLeft:"auto",background:"rgba(34,197,94,.12)",border:"1px solid rgba(34,197,94,.3)",color:"#22c55e",borderRadius:7,padding:"4px 12px",cursor:"pointer",fontSize:11,fontWeight:700,whiteSpace:"nowrap" }}>+ Add</button>
          </div>
        </div>
      </header>
