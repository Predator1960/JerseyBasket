              ...
              (() => {
                ...
                return groups.map(g => (
                  <div key={g.cat} style={{ marginBottom:18 }}>
                    <div style={{ fontSize:11, fontWeight:700, color:"#64748b", textTransform:"uppercase", letterSpacing:"0.08em", padding:"6px 4px 8px", borderBottom:"1px solid rgba(255,255,255,.07)", marginBottom:10 }}>
                      {g.cat} <span style={{ opacity:.5, fontWeight:500 }}>({g.products.length})</span>
                    </div>
