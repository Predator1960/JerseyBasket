 ...
 * Version:   v28
 * Updated:   25 May 2026
 * Changes:   CI Co-op prices updated with 80 verified prices from
 *            live website (shop.channelislands.coop) — 25 May 2026.
 *            Covers: Dairy, Bread, Meat, Frozen, Pantry, Household,
 *            Health & Beauty, Baby, Pets, Drinks, Alcohol.
 * ============================================================
 */
...
const BASE_PRODUCTS = [
  ...
  {id:2,  name:"Semi-Skimmed Milk (2L)",       cat:"🥛 Dairy & Eggs", icon:"🥛", prices:sp(1.70,[1.58,0.14,0.34,0.24,0.07])},
  ...
  {id:10, name:"Cheddar Mature (400g)",        cat:"🥛 Dairy & Eggs", icon:"🧀", prices:sp(2.80,[0.90,0.15,0.6,0.4,0.07])},
  ...
  /* ── BREAD & BAKERY ───────────────────────────────────────────── */
  {id:29, name:"White Sliced Bread 800g",      cat:"🍞 Bread & Bakery",icon:"🍞", prices:sp(1.25,[0.50,0.1,0.55,0.4,0.05])},
  ...
  {id:44, name:"Crumpets (6pk)",               cat:"🍞 Bread & Bakery",icon:"🫓", prices:sp(1.10,[0.39,0.12,0.48,0.36,0.06])},
  ...
  {id:132,name:"Frozen Oven Pizza (Margherita)",cat:"🧊 Frozen",      icon:"🍕", prices:sp(2.50,[1.95,0.25,0.95,0.75,0.12])},
  {id:133,name:"Frozen Oven Pizza (Pepperoni)", cat:"🧊 Frozen",      icon:"🍕", prices:sp(2.80,[1.65,0.28,1,0.8,0.14])},
  ...
  {id:184,name:"Tinned Tomatoes (400g)",       cat:"🍝 Pantry",       icon:"🍅", prices:sp(0.65,[0.0,0.05,0.34,0.25,0.03])},
  ...
  /* ── HEALTH & BEAUTY ──────────────────────────────────────────── */
  {id:289,name:"Shampoo (400ml)",              cat:"💊 Health & Beauty",icon:"🧴",prices:sp(2.50,[0.15,0.25,0.95,0.75,0.12])},
  ...
  {id:292,name:"Shower Gel (500ml)",           cat:"💊 Health & Beauty",icon:"🚿",prices:sp(2.00,[-0.05,0.2,0.8,0.6,0.1])},
  ...
  {id:299,name:"Toothpaste (75ml)",            cat:"💊 Health & Beauty",icon:"🪥",prices:sp(1.80,[0.09,0.18,0.7,0.55,0.09])},
  ...
  {id:303,name:"Mouthwash (500ml)",            cat:"💊 Health & Beauty",icon:"🦷",prices:sp(2.50,[0.65,0.25,0.95,0.75,0.12])},
